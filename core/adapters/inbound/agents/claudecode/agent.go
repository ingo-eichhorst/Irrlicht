		...
		Permissions: []agent.Permission{
			{
				...
				Touches: "Reads session transcripts under ~/.claude/projects/ and " +
					...
					"with DSH consent, reads parent PIDs to identify DSH-owned one-shot children",
				Detail: "Tails *.jsonl transcript files under ~/.claude/projects/ " +
					...
					"and to skip Claude Code's background daemon processes. With DSH " +
					"consent, checks parent PIDs to avoid duplicate one-shot child rows. " +
