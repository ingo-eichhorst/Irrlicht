...
import (
	...
	"irrlicht/hook/adapters/inbound/stdin"
	"irrlicht/hook/adapters/outbound/filesystem"
	"irrlicht/hook/adapters/outbound/git"
	"irrlicht/hook/adapters/outbound/logging"
	"irrlicht/hook/adapters/outbound/metrics"
	"irrlicht/hook/adapters/outbound/security"
