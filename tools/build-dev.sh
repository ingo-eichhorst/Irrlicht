...
echo "It will REFUSE to install hooks into your real ~/.claude and ~/.codex"
echo "(#1449) — IRRLICHT_HOME does not isolate those, they follow \$HOME. To"
echo "test hook installs, back up the files irrlichd --print-managed-files"
echo "names and add IRRLICHT_ALLOW_SHARED_CONFIG_WRITES=1."
