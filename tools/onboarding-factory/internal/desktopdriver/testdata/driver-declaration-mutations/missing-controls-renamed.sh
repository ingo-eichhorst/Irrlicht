...
DRIVE_MISSING_CONTROLS="exit_clean:session-exit reset_session:session-reset restart:session-restart resume:session-resume session:sidebar-row sigkill:agent-process-kill slash:slash-command-step"
