...
import { agentsPerPage, coverageBadge, inferDriverLabel, paginateAgents, renderMarkdown, renderManifestFields } from './viewer.js'
...
// issue rejects. See internal/matrix/vocabulary.go for the schema.
...
describe('coverageBadge — not-applicable display state', () => {
  test('renders the canonical "n/a" state', () => {
    ...
    // Not the grey "unknown" fallback, which would silently mis-bucket every
